...
struct I32 {
    #[doc(hidden)]
    __private_inner: ::stacklover::__private_mod::ErasedStorage<{ I32::__SIZE }, { I32::__ALIGN }>,
}
const _: () = {
    ...
    fn __stacklover_inner_unreachable() -> i32 {
        let __stacklover_inner_to_struct_fn_unreachable =
            |inner| -> I32 { ::core::panicking::panic("internal error: entered unreachable code") };
        let _ = {
            let created_value = __stacklover_create(::core::panicking::panic(
    ...
    impl I32 {
        ...
        pub fn new(dep2: i32) -> __StackloverWrappedType<Self> {
            let __stacklover_inner_to_struct_fn = |inner| I32 {
    ...
    const _: () = {
        {
            match ::core::mem::size_of::<I32>() == I32::__SIZE {
                true => {}
                _ => {
        ...
        {
            match ::core::mem::align_of::<I32>() == I32::__ALIGN {
                true => {}
                _ => {
    ...
    impl I32 {
        ...
        #[inline(always)]
        pub fn as_pin_mut(self: ::core::pin::Pin<&mut Self>) -> ::core::pin::Pin<&mut (i32)> {
